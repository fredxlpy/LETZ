...
train_set.to_excel('Data/Ours/translation_dataset/train.xlsx', index=False)
val_set.to_excel('Data/Ours/translation_dataset/val.xlsx', index=False)
test_set.to_excel('Data/Ours/translation_dataset/test.xlsx', index=False)